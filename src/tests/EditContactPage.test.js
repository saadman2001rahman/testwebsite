...
describe('EditContactPage Component', () => {
    ...
    it('calls the correct function when "Save Changes" button is clicked, both names', async () => {
        ...
        fireEvent.change(screen.getByLabelText('First Name:'), { target: { value: 'UpdatedName' } });
        fireEvent.change(screen.getByLabelText('Last Name (Optional):'), { target: { value: 'UpdatedLastName' } });
    ...
    it('Gives the correct error message when first name is too short', async () => {
        ...
        fireEvent.change(screen.getByLabelText('First Name:'), { target: { value: 'ss' } });
        fireEvent.click(screen.getByText('Save Changes'));
